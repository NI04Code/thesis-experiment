...
OUTPUT_DIR="$EXPERIMENT_ROOT/results/resource-defragmentation/walkthrough/r1-load/$TIMESTAMP"
mkdir -p "$OUTPUT_DIR"
...
"$SHARED_ROOT/scripts/cleanup.sh"
...
"$SHARED_ROOT/scripts/run-descheduler.sh" "$ROOT/policies/r1-rdc2-actual.yaml" "$OUTPUT_DIR"
