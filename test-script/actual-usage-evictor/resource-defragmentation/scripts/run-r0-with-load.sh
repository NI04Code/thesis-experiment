...
OUTPUT_DIR="$EXPERIMENT_ROOT/results/resource-defragmentation/walkthrough/r0-load/$TIMESTAMP"
mkdir -p "$OUTPUT_DIR"
...
"$SHARED_ROOT/scripts/run-descheduler.sh" "$ROOT/policies/r0-rdc2.yaml" "$OUTPUT_DIR"
